...
export const INITIAL_MILESTONES: CompanyMilestone[] = [
  ...
  {
    year: '2024',
    title: 'Lançamento do FIEL e Nova Identidade Visual',
    description: 'Apresentação do FIEL, mascote oficial da RCM, e da assinatura corporativa em azul e laranja, simbolizando calor humano, inovação e proximidade.',
