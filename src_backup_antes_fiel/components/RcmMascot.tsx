...
export const RcmMascot: React.FC<RcmMascotProps> = ({
  ...
  const contextData = {
    home: {
      ...
      message: 'Olá! Sou o mascote oficial da RCM. Estamos prontos para atender você com combustível de procedência garantida e o melhor atendimento.',
  ...
  if (position === 'card') {
    return (
      <div
        ...
        className={`relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-950 p-6 sm:p-8 text-white shadow-xl border border-blue-700/40 ${className}`}
      >
          ...
          <div className="shrink-0 animate-rcm-float">
            <div className="relative">
              <img
                ...
                className="relative w-52 sm:w-64 h-auto object-contain drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]"
              />
            </div>
          </div>

          <div className="flex-1 text-center md:text-left">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-500/20 text-orange-300 text-xs font-semibold tracking-wide uppercase mb-3 border border-orange-500/30">
            ...
            <p className="text-blue-100/90 text-sm sm:text-base leading-relaxed mb-5 max-w-xl">
              {displayMessage}
            </p>
            {onCtaClick && (
              <button
